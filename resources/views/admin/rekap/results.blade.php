<?php
// File: resources/views/admin/rekap/results.blade.php
?>
<x-app-layout>
    ...
    @php
        ...
        // Asumsi model App\Models\User sudah di-import di layout/controller
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <a href="{{ route('admin.rekap.form') }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            if (typeof DataTable !== 'undefined' && document.getElementById('rekapTable')) {
                                new DataTable('#rekapTable', {
                                    ...
                                    "columnDefs": [
                                        // Kolom 4 (Laporan Harian) juga bisa diabaikan sorting/searching-nya
