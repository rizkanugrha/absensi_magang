    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        <aside class="w-64 bg-white border-r">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('attendance.index') }}" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-100">
                ...
                <a href="{{ route('attendance.rekap') }}" class="flex items-center px-6 py-3 text-blue-600 bg-blue-50 font-medium">
                    ...
                    <td class="px-3 py-2">
                        @if($attendance->check_in_photo)
                            <img src="{{ asset('storage/' . $attendance->check_in_photo) }}"
                                 class="w-450 h-300 rounded object-cover border" alt="">
                        @else
